...
const Forgetpassword = () => {
  ...
  return (
    <section className='h-[100vh] flex items-center justify-center p-4'>
      <form noValidate className='w-full max-w-[24rem] p-6 md:p-10 flex flex-col justify-center gap-4 text-white shadow-[0_0_10px_white] bg-cyan-900 rounded-lg' onSubmit={onFormSubmit}>
