...
function TeacherClasses() {
    ...
    return (
        <div className='ml-0 md:ml-60 mt-8 md:mt-20 text-white flex flex-col lg:flex-row justify-between mr-0 md:mr-20 lg:mr-80 px-4 md:px-10 gap-10 relative'>
            <div className='w-full max-w-[30rem] flex flex-col'>
                <div className='flex justify-between items-center mb-4 flex-wrap gap-3'>
                    <h1 className='text-[#1671D8] text-2xl font-semibold'>Weekly Schedule</h1>
                    <button onClick={() => setShowPopup(true)} className='bg-blue-900 hover:bg-blue-800 text-white p-2 rounded-sm cursor-pointer font-medium text-sm'>
                        + ADD CLASS
                    </button>
                </div>
                    ...
                    <div className='bg-white p-5 h-auto min-h-52 cursor-pointer rounded-lg text-black w-full'>
                        ...
                        <div className='flex gap-6 md:gap-12 items-center justify-between'>
                            <div className='ml-3'>
                                ...
                                <p className='text-[#018280] text-2xl md:text-3xl font-semibold'>{data[0]?.coursename.toUpperCase()}</p>
